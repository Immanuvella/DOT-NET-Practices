...
//program related to class and constructors
namespace Classes1
{
    internal class Program
    {
        ...
        {
            Employee e1 = new Employee();//unparameterized constructor
            Employee e2 = new Employee(102,"Arun",25000);//parameterized constructor
